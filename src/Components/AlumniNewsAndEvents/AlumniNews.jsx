    ...
    const newsItems = [
        {
            ...
            excerpt:
                "The Important factor to bear in mind Post Graduate Studies: The Important factor to bear in mind Post Graduate Studies...",
            image:
        ...
        <div className="min-h-screen bg-white mb-24">
            ...
            <div className="max-w-6xl mx-auto px-6 sm:px-0 lg:px-0">
                <div className="flex mt-2 flex-col md:flex-row md:items-start md:justify-between mb-6">
                    <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2 md:mb-0">News on Alumni Matters</h1>
                ...
                <div className="flex flex-col md:flex-row">
                    ...
                    <div className="flex-1 mt-8 md:mt-0">
                        ...
                        <div className="flex justify-between items-center  mb-6">
                            <p className="text-sm text-gray-500">{newsItems.length} results</p>
