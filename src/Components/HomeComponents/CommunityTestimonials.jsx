...
//   // Update visible testimonials when window resizes or currentIndex changes
...
//     // Ensure we always show the correct number of testimonials
...
//   return (
//     <section className="w-full bg-[#0066CC] py-16 px-4 sm:px-6 lg:px-8 text-white">
//       <div className="max-w-6xl mx-auto">
//         <h2 className="text-3xl font-bold mb-10 text-center">What Our community have to say about us</h2>
...
//                 >
//                   <div className="bg-[#0077E6] rounded-lg p-6 h-full flex flex-col">
//                     {/* Quote mark */}
//                     <div className="text-4xl text-white opacity-70 mb-4">“</div>
...
//                 className={`w-2 h-2 mx-1 rounded-full transition-colors ${index === currentIndex ? 'bg-white' : 'bg-white/30'}`}
