    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-32">
      ...
      >
        <div className="flex items-center mb-4">
          ...
          <span className="text-sm font-medium uppercase tracking-wider text-orange-500">Alumni Portal Project</span>
        </div>
        <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">{projectData.title}</h1>
        <p className="text-lg text-gray-600 max-w-3xl">
          Bridging the gap between graduates and their alma mater through modern digital experience
        </p>
      </motion.div>
        ...
        >
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              The platform was designed with a focus on fostering meaningful connections between alumni and their
              university. Our team implemented features that encourage networking, facilitate donations, and keep
              graduates informed about university developments and opportunities for continued engagement.
            </p>
          </div>
        </motion.div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="rounded-xl overflow-hidden">
            <div
              ...
              style={{
                backgroundImage: `url('/src/assets/works/alumnione.png')`,
                backgroundSize: "cover",
                backgroundPosition: "center",
              }}
            ></div>
          ...
          <div className="rounded-xl overflow-hidden">
            <div
              className="w-full h-[300px] bg-gray-100"
              style={{
                backgroundImage: `url('/src/assets/works/alumnitwo.png')`,
                backgroundSize: "cover",
                backgroundPosition: "center",
              }}
            ></div>
